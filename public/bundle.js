...
function render(variables = {}) {
  ...
  if (variables.name == null) variables.name = "Ramon";
  if (variables.lastname == null) variables.lastname = "Andrade";
  if (variables.socialMediaPosition === "position-right") variables.socialMediaPosition = "position-right";else variables.socialMediaPosition = "position-left";
  ...
  if (variables.linkedin == null) variables.lastname = "";
